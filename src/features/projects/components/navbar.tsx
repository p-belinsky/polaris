        ...
        <nav className='flex justify-between items-center gap-x-2 p-2 bg-sidebar border-b'>
            <div className='flex items-center gap-x-2'>
                <Breadcrumb>
                    ...
                    <BreadcrumbItem>
                        <BreadcrumbLink
                            className="flex items-center gap-1.5" asChild
                        >
                    ...
                    <BreadcrumbItem>
                        {isRenaming ? (
                            ...
                            <BreadcrumbPage onClick={handleStartRename} className='text-sm cursor-pointer hover:text-primary font-medium max-w-40 truncate'>{project?.name ?? "Loading..."}
                            </BreadcrumbPage>
                        )}
